...
$faqs_defaults = [
    ...
    [ 'question' => 'Is there an age restriction?',                 'answer' => '<strong>Yes, this service is strictly for ages 18 and over only.</strong> There is a strict no-refund policy, as clinical times and resources have been allocated. Please do not book for any persons under the age of 18.' ],
...
<div class="bg-amber-50 border-t border-amber-200 py-6">
  <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex items-start gap-3">
      ...
      <p class="text-amber-800 text-sm leading-relaxed font-jost"><strong>Age Restriction:</strong> This service is strictly for age 18+ only. There is a strict no-refund policy, as clinical times and resources have been allocated. Please do not book for any persons under the age of 18.</p>
    </div>
  </div>
</div>

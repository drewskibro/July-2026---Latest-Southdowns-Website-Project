 ...
 *
 * Hampshire Kenya travel health & vaccinations landing page.
 *
...
<!-- INTERIM CONTENT: Kenya destination copy is placeholder pending the client's clinical brief — all medical content to be reviewed before publication. -->
...
<section class="relative w-full min-h-[500px] lg:min-h-[600px] overflow-hidden">
  ...
  <div class="hidden lg:grid grid-cols-2 min-h-[600px]">
    ...
    <!-- Right: image -->
    <div class="relative">
      <img src="<?php echo esc_url( sp_field( 'tv_hero_image', 'https://images.unsplash.com/photo-1516026672322-bc52d61a55d5?w=1200&q=80&auto=format&fit=crop' ) ); ?>" alt="Kenya savannah at sunset" class="absolute inset-0 w-full h-full object-cover" loading="eager"/>
  ...
  <div class="lg:hidden relative min-h-[500px]" style="background:#1a73e9;">
    <img src="<?php echo esc_url( sp_field( 'tv_hero_image', 'https://images.unsplash.com/photo-1516026672322-bc52d61a55d5?w=1200&q=80&auto=format&fit=crop' ) ); ?>" alt="Kenya savannah at sunset" class="absolute inset-0 w-full h-full object-cover opacity-30" loading="eager"/>

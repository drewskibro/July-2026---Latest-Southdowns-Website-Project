 ...
 *
 * Hampshire Africa travel health & vaccinations landing page.
 *
...
<!-- INTERIM CONTENT: Africa region copy is DRAFT pending the pharmacist's clinical sign-off (Nemesh Patel, GPhC 2061623) — all medical content to be reviewed before publication. -->
...
<section class="relative w-full min-h-[500px] lg:min-h-[600px] overflow-hidden">
  ...
  <div class="hidden lg:grid grid-cols-2 min-h-[600px]">
    ...
    <div class="relative flex items-center px-12 xl:px-20 py-20" style="background:#1a73e9;">
      ...
      <div class="relative z-10 max-w-xl">
        ...
        <div class="flex flex-col sm:flex-row gap-3 mb-8">
          <a href="#book" class="inline-flex items-center justify-center gap-2 bg-white text-blue-700 font-bold px-6 py-3.5 rounded-xl font-jost hover:bg-blue-50 transition-colors duration-200 shadow-lg">
    ...
    <!-- Right: image -->
    <div class="relative">
      <img src="<?php echo esc_url( sp_field( 'tv_hero_image', 'https://images.unsplash.com/photo-1516026672322-bc52d61a55d5?w=1200&q=80&auto=format&fit=crop' ) ); ?>" alt="African savannah at sunset" class="absolute inset-0 w-full h-full object-cover" loading="eager"/>
  ...
  <div class="lg:hidden relative min-h-[500px]" style="background:#1a73e9;">
    <img src="<?php echo esc_url( sp_field( 'tv_hero_image', 'https://images.unsplash.com/photo-1516026672322-bc52d61a55d5?w=1200&q=80&auto=format&fit=crop' ) ); ?>" alt="African savannah at sunset" class="absolute inset-0 w-full h-full object-cover opacity-30" loading="eager"/>
    ...
    <div class="relative z-10 px-6 py-16 sm:px-10 max-w-2xl">
      ...
      <div class="flex flex-col gap-3 mb-6">
        <a href="#book" class="inline-flex items-center justify-center gap-2 bg-white text-blue-700 font-bold px-5 py-3 rounded-xl font-jost hover:bg-blue-50 transition-colors duration-200 shadow-lg">
          <?php echo sp_field( 'tv_hero_btn1', $tv['tv_hero_btn1'] ); ?>
        </a>
    ...
    <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
      ...
      <div class="bg-white rounded-2xl overflow-hidden shadow-sm border border-slate-100 hover:shadow-lg transition-shadow duration-300 reveal-item flex flex-col">
        ...
        <div class="p-5 space-y-2.5 flex flex-col flex-1">
          ...
          <a href="#book" class="mt-auto pt-1 inline-flex items-center gap-1.5 text-blue-600 font-semibold text-sm font-jost hover:text-blue-700 transition-colors duration-200">
            Book here
            <svg class="w-3.5 h-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14M12 5l7 7-7 7"/></svg>
          </a>
        </div>
...
<section id="book" class="py-20 md:py-28 bg-[#fdf9f6] border-t border-[#e8e0d8]">
  <div class="section-container">
    <div class="text-center mb-8 md:mb-10">
      ...
      <h2 class="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-slate-800 mb-6 font-jost">Book Your Africa Travel Consultation</h2>
...
<section id="book-cta" class="py-20 md:py-28 relative overflow-hidden" style="background: linear-gradient(160deg,#0f172a 0%,#1e3a8a 55%,#1d4ed8 100%);">
  ...
  <div class="section-container relative z-10 text-center">
    ...
    <div class="flex flex-col sm:flex-row gap-4 justify-center mb-16">
      <a href="#book" class="inline-flex items-center justify-center gap-2 bg-white text-blue-700 font-bold px-8 py-4 rounded-xl font-jost hover:bg-blue-50 transition-colors duration-200 shadow-xl shadow-blue-900/30 text-lg">
        <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>

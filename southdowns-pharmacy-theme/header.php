...
$destinations = [
    ...
    [ 'name' => 'Australasia & Pacific', 'flag' => 'au', 'desc' => 'Low risk — honest advice', 'url' => home_url( '/australasia-and-pacific-travel-vaccinations/' ) ],
              ...
              <div class="mega-dd">
                <div class="mega-dd-content">
                  ...
                  <div class="mega-dd-section">
                    ...
                    <a href="<?php echo esc_url( home_url( '/meningitis-b-vaccine-nhs/' ) ); ?>" class="mega-dd-link">
    ...
    <ul class="font-jost">
      ...
      <li class="border-b border-stone-200">
        ...
        <div class="mob-dd-sub">
          ...
          <a href="<?php echo esc_url( home_url( '/meningitis-b-vaccine-nhs/' ) ); ?>">Meningitis B Vaccine</a>
        </div>
      </li>

...
function tv_defaults(): array {
	return [
		// ── AFRICA (region page) — DRAFT: all clinical content pending pharmacist sign-off (Nemesh Patel, GPhC 2061623). ──
		'africa' => [
			'tv_hero_pill'  => 'Africa Travel Health &middot; Hampshire',
			'tv_hero_h1'    => 'Travel Vaccines for Africa in Hampshire',
			'tv_hero_intro' => 'Expert travel health advice and every essential vaccine for your trip to Africa &mdash; from safari and Sub-Saharan adventures to North African city breaks. Same-day appointments across our Hampshire travel clinics, no waiting lists.',
			'tv_hero_btn1'  => 'Book a Travel Consultation',
			'tv_hero_btn2'  => 'Check What Vaccines You Need',
			'tv_hero_pills' => [ [ 'text' => 'GPhC Registered' ], [ 'text' => 'Same-Day Appointments' ], [ 'text' => 'Expert Pharmacist Advice' ], [ 'text' => '4 Hampshire Locations' ], [ 'text' => 'NaTHNaC Yellow Fever Centre' ] ],
			...
			'tv_intro_h2'   => 'Essential Vaccinations for Travel to Africa',
			'tv_intro_p1'   => 'Planning a trip to Africa from Hampshire? Africa is a vast and varied continent, and the vaccines you need depend heavily on which countries you are visiting and what you will be doing.',
			'tv_intro_p2'   => 'Our travel clinics in Emsworth, Havant and Rowlands Castle provide comprehensive vaccination services and personalised travel health advice for every African itinerary &mdash; whether that is a Kenyan safari, a Cape Verde beach holiday, a Gambia getaway, or business travel to Lagos or Johannesburg. Our GPhC-registered pharmacists review your route, activities and medical history to build a plan tailored to your trip.',
			'tv_vax_eyebrow' => 'Vaccination Guide',
			'tv_vax_h2'     => 'Recommended Vaccines for Travel to Africa',
			'tv_vax_intro'  => 'Our pharmacists confirm exactly which vaccines you need based on your destinations, itinerary and medical history. The following are the vaccines most commonly recommended for travel to Africa.',
			'tv_vaccines'   => [
				[ 'category' => 'Recommended Vaccines', 'name' => 'Hepatitis A', 'who' => 'All travellers', 'doses' => '1 dose (booster at 6&ndash;12 months)', 'desc' => 'Spread through contaminated food and water and recommended across the continent. A single dose gives long-term protection, with a booster extending it for years.' ],
				[ 'category' => 'Recommended Vaccines', 'name' => 'Typhoid', 'who' => 'All travellers, especially outside main resorts', 'doses' => '1 dose', 'desc' => 'Recommended where food and water hygiene may be variable. Our pharmacists will confirm whether it is advised for your destinations and style of travel.' ],
				[ 'category' => 'Recommended Vaccines', 'name' => 'Rabies', 'who' => 'Adventure travellers, remote areas, likely animal contact, families with young children', 'doses' => '3 doses over 21&ndash;28 days', 'desc' => 'Present across much of Africa and fatal once symptoms appear, so pre-exposure cover is sensible for higher-risk trips. Ask our pharmacists whether it is right for your itinerary.' ],
				[ 'category' => 'Recommended Vaccines', 'name' => 'Meningococcal Meningitis (ACWY)', 'who' => 'Travellers to the "meningitis belt" of Sub-Saharan Africa, and required for Hajj/Umrah', 'doses' => '1 dose', 'desc' => 'Recommended for the meningitis belt of Sub-Saharan Africa and a mandatory requirement for Hajj and Umrah pilgrims.' ], // PHARMACIST sign-off pending: confirm ACWY set for this region.
				[ 'category' => 'Required Vaccines', 'name' => 'Yellow Fever', 'who' => 'Required for entry to many African countries', 'doses' => '1 dose (lifetime)', 'desc' => 'Mandatory for entry to parts of Sub-Saharan Africa, and an ICVP certificate is often required. Available at our Bosmere Pharmacy, Havant location only, as a NaTHNaC-registered Yellow Fever Vaccination Centre.' ],
				[ 'category' => 'Recommended Vaccines', 'name' => 'Also Consider &mdash; Cholera, Hepatitis B, Tetanus/Diphtheria/Polio', 'who' => 'Depending on itinerary &mdash; pharmacist to advise', 'doses' => 'Varies', 'desc' => 'Cholera for higher-risk areas or aid and relief work; Hepatitis B for longer stays, healthcare work or possible medical exposure; and a Tetanus, Diphtheria &amp; Polio booster to ensure your UK schedule is up to date.' ],
				[ 'category' => 'Antimalarial Protection', 'name' => 'Malaria (Antimalarial Tablets)', 'who' => 'Much of Sub-Saharan Africa', 'doses' => 'Tablets &mdash; not a vaccine', 'desc' => 'Malaria is a significant risk across much of Sub-Saharan Africa. Antimalarial tablets are not a vaccine but are an essential part of preparing for many African trips &mdash; see the malaria section below.' ],
			],
			'tv_risk_eyebrow' => 'Risk Awareness',
			'tv_risk_h2'    => 'Health Risks When Travelling to Africa',
			...
			'tv_risks'      => [
				[ 'title' => 'Malaria &amp; Mosquito-Borne Diseases', 'desc' => 'Malaria, dengue and other mosquito-borne illnesses are the most important consideration for many African trips. Antimalarial tablets where appropriate, DEET-based repellent and good bite avoidance all help reduce the risk.' ],
				[ 'title' => 'Food &amp; Water Safety', 'desc' => "Travellers' diarrhoea, typhoid and hepatitis A can be linked to contaminated food and water. Stick to bottled or treated water, be careful with ice, and choose freshly cooked food &mdash; avoiding uncooked or unpeeled items where hygiene may be variable." ],
				[ 'title' => 'Rabies from Animal Bites', 'desc' => 'Rabies is present across much of Africa. Avoid contact with animals, and seek prompt medical advice after any bite or scratch &mdash; even if you have had the pre-exposure vaccine.' ],
				[ 'title' => 'Sun, Heat &amp; Altitude', 'desc' => 'From desert heat to highland trekking, conditions vary enormously. Stay hydrated, use high-factor sun protection, and allow time to acclimatise if you are travelling to altitude.' ],
			],
			'tv_mal_eyebrow' => 'Malaria Risk',
			'tv_mal_h2'     => 'Malaria Prevention for Africa',
			'tv_mal_intro'  => 'Malaria is a significant risk across much of Sub-Saharan Africa. Antimalarial tablets, taken correctly alongside good bite avoidance, are an essential part of preparing for many African trips.',
			'tv_malaria'    => [
				[ 'title' => 'Risk Varies by Itinerary', 'desc' => 'Malaria risk varies widely by country, region, altitude and season. Our pharmacists assess your specific itinerary to advise whether antimalarial tablets are recommended for your trip.' ],
				[ 'title' => 'Antimalarial Options', 'desc' => 'We can supply Malarone (atovaquone/proguanil), Doxycycline and Mefloquine. The right choice depends on your health, destinations and length of stay.' ], // PHARMACIST sign-off pending: confirm stocked antimalarial options.
				[ 'title' => 'Bite Prevention', 'desc' => 'Use DEET-based repellent, cover up after dark, and sleep under treated mosquito nets where rooms are not screened or air-conditioned. DEET repellents are stocked at all four branches.' ],
			],
			'tv_how_eyebrow' => 'Three-Step Process',
			'tv_how_h2'     => 'How to Get Your Africa Travel Vaccinations at Southdowns Pharmacy',
			'tv_how_intro'  => 'Three simple steps from booking to being fully protected.',
			'tv_how_steps'  => [
				[ 'title' => 'Book Your Consultation', 'desc' => 'Book online or visit any of our Hampshire branches during opening hours &mdash; walk-ins are welcome. We serve patients from across Hampshire including Portsmouth, Southsea, Waterlooville, Havant, Fareham, Gosport and Chichester.' ],
				[ 'title' => 'Expert Travel Health Assessment', 'desc' => 'Our GPhC-registered pharmacists review your itinerary, medical history and planned activities to build a personalised plan &mdash; identifying exactly which vaccines and antimalarials you need for your African trip.' ],
				[ 'title' => 'Same-Day Vaccination', 'desc' => 'Receive your vaccines at the same appointment. Recommended vaccines are in stock across our branches, with Yellow Fever available at our Bosmere, Havant branch only.' ],
			],
			'tv_time_eyebrow' => 'Timing Guide',
			'tv_time_h2'    => 'When to Get Your Africa Travel Vaccinations',
			'tv_time_intro' => "Ideally book 6&ndash;8 weeks before departure &mdash; but don't worry if your trip is sooner. We accommodate last-minute travellers with same-day appointments.",
			'tv_timing'     => [
				[ 'tag' => 'Ideal', 'time' => '6–8 Weeks Before', 'desc' => "Best timing for multi-dose courses such as Rabies, and to allow the Yellow Fever certificate's 10-day validity period before you travel." ],
				[ 'tag' => 'Good', 'time' => '2–4 Weeks Before', 'desc' => 'Still time for single-dose vaccines including Hepatitis A and Typhoid, and to start antimalarial tablets before departure.' ],
				[ 'tag' => 'Last Minute', 'time' => 'Days Before Departure', 'desc' => "Don't skip it &mdash; some protection is always better than none. Many vaccines can be given same-day. Come in even if you're leaving within days." ],
			],
			'tv_price_eyebrow' => 'Transparent Pricing',
			'tv_price_h2'   => 'Africa Travel Vaccination Pricing',
			...
			'tv_pkg1_title' => 'Essential Africa Package',
			'tv_pkg1_price' => '£TBC',
			...
			'tv_pkg2_title' => 'Comprehensive Africa Package',
			'tv_pkg2_price' => '£TBC',
			'tv_pkg2_items' => [ [ 'text' => 'Hepatitis A &amp; Typhoid vaccinations' ], [ 'text' => 'Yellow Fever (at Bosmere, Havant)' ], [ 'text' => 'Antimalarial advice &amp; tablets' ], [ 'text' => 'Travel health consultation' ] ],
			'tv_individual' => [
				...
				[ 'name' => 'Meningitis ACWY', 'price' => '£TBC' ],
			...
			'tv_loc_intro'  => 'Africa travel vaccinations available across our Southdowns Pharmacy travel clinics. Same-day appointments subject to availability. Free parking at all branches.',
			...
			'tv_why_h2'     => 'Why Choose Southdowns Pharmacy for Your Africa Travel Vaccinations?',
			'tv_why'        => [
				[ 'title' => 'Expert GPhC-Registered Pharmacists', 'desc' => 'Qualified specialists in travel health providing evidence-based, personalised vaccination advice for every African itinerary.' ],
				[ 'title' => 'Africa Travel Vaccines in Stock', 'desc' => 'No ordering delays &mdash; we carry the recommended vaccines for African travel across our Hampshire branches.' ],
				[ 'title' => 'Same-Day Appointments', 'desc' => 'Walk in or book ahead &mdash; no waiting weeks for your travel vaccination appointment.' ],
				[ 'title' => 'NaTHNaC Yellow Fever Centre at Bosmere', 'desc' => 'Our Bosmere Pharmacy, Havant branch is an officially designated Yellow Fever Vaccination Centre, authorised to issue valid ICVP certificates.' ],
				...
				[ 'title' => 'Family-Friendly Consultations', 'desc' => 'Child-safe dosing expertise and a welcoming environment for families travelling to Africa with children of all ages.' ],
			],
			'tv_faq_eyebrow' => 'Common Questions',
			'tv_faq_h2'     => 'Frequently Asked Questions',
			'tv_faq_intro'  => 'Everything you need to know about Africa travel vaccinations at Southdowns Pharmacy.',
			'tv_faqs'       => [
				[ 'question' => 'Which vaccines do I need for Africa?', 'answer' => 'It depends on the countries you are visiting, your itinerary and your medical history. Hepatitis A and Typhoid are commonly recommended, with Yellow Fever, Rabies and Meningitis ACWY advised for many itineraries. Our pharmacists confirm exactly what you need at your consultation.' ],
				[ 'question' => 'Do I need a Yellow Fever certificate for Africa?', 'answer' => 'Many African countries require proof of Yellow Fever vaccination for entry. The ICVP certificate becomes valid 10 days after vaccination, so book early. Our pharmacists will check your full itinerary and advise whether it is required for your trip.' ],
				[ 'question' => 'Where can I get the Yellow Fever vaccine?', 'answer' => 'Yellow Fever vaccinations and ICVP certificates are available at our Bosmere Pharmacy, Havant location only, which is a NaTHNaC-registered Yellow Fever Vaccination Centre.' ],
				[ 'question' => 'Is malaria a risk in Africa?', 'answer' => 'Yes &mdash; malaria is a significant risk across much of Sub-Saharan Africa. Antimalarial tablets, taken correctly alongside good bite avoidance, are an essential part of preparing for many African trips. Our pharmacists assess your itinerary and can supply the right antimalarials.' ],
				[ 'question' => 'How far in advance should I book?', 'answer' => "Ideally 6&ndash;8 weeks before departure, to allow for multi-dose courses such as Rabies and the Yellow Fever certificate's 10-day validity. However, we welcome last-minute travellers &mdash; many vaccines can be given same-day." ],
				[ 'question' => 'Can my whole family get vaccinated together?', 'answer' => 'Yes. We welcome families and can vaccinate adults and children at the same appointment, with expertise in child-safe dosing for younger travellers.' ],
				[ 'question' => 'Can I get antimalarial tablets at the same appointment?', 'answer' => 'Yes. Where antimalarials are recommended for your itinerary, our pharmacists can supply them at the same appointment as your vaccinations.' ],
			],
			...
			'tv_cta_h2'     => 'Travelling to Africa?<br>Get Protected Before You Go.',
			'tv_cta_intro'  => 'Book your Africa travel vaccination consultation at any of our Hampshire locations. Expert advice, recommended vaccines in stock, same-day appointments available.',
		...
		// NOTE: Caribbean differs from Africa clinically — malaria is NOT a general
		// risk (Haiti / parts of the DR excepted) and Yellow Fever is NOT generally
		// required (Trinidad & Tobago and transit cases excepted). Dengue is the main
		// mosquito-borne concern. Do not reuse Africa's malaria/YF framing here.
		'caribbean' => [
			'tv_hero_pill'  => 'Caribbean Travel Health &middot; Hampshire',
			'tv_hero_h1'    => 'Travel Vaccines for the Caribbean in Hampshire',
			'tv_hero_intro' => 'Heading to the Caribbean? Whether it is Jamaica, Barbados, the Dominican Republic, St Lucia or a multi-island cruise, a short travel health appointment makes sure you are protected before you fly. Same-day appointments across our Hampshire pharmacies, with no waiting lists and no GP referral.',
			'tv_hero_btn1'  => 'Book a Travel Consultation',
			'tv_hero_btn2'  => 'Check What Vaccines You Need',
			'tv_hero_pills' => [ [ 'text' => 'GPhC Registered' ], [ 'text' => 'Same-Day Appointments' ], [ 'text' => 'Expert Pharmacist Advice' ], [ 'text' => '4 Hampshire Locations' ] ],
			'tv_hero_image' => 'https://images.unsplash.com/photo-1580541832626-2a7131ee809f?w=1200&q=80&auto=format&fit=crop',
			'tv_intro_eyebrow' => 'Travel Health Advice',
			'tv_intro_h2'   => 'Essential Vaccinations for Caribbean Travel',
			'tv_intro_p1'   => 'Planning a Caribbean holiday from Hampshire? The good news is that the Caribbean is a lower-risk destination than many tropical regions &mdash; malaria is not a concern on most islands. But a few vaccines are still strongly recommended, and the right advice depends on which islands you are visiting and how you are travelling.',
			'tv_intro_p2'   => 'Our travel clinics in Havant, Emsworth and Rowlands Castle provide vaccination services and personalised advice for every Caribbean itinerary, from an all-inclusive resort stay to island-hopping, cruising or visiting family. Our GPhC-registered pharmacists review your route, activities and medical history and recommend only what you actually need.',
			'tv_vax_eyebrow' => 'Vaccination Guide',
			'tv_vax_h2'     => 'Recommended Vaccines for the Caribbean',
			'tv_vax_intro'  => 'Our pharmacists confirm exactly which vaccines you need based on your islands, itinerary and medical history. These are the vaccines most commonly recommended for Caribbean travel.',
			'tv_vaccines'   => [
				[ 'category' => 'Recommended Vaccines', 'name' => 'Hepatitis A', 'who' => 'All travellers', 'doses' => '1 dose (booster at 6&ndash;12 months)', 'desc' => 'Spread through contaminated food and water. Recommended for most Caribbean travellers, including resort stays, as a single dose gives long-lasting protection.' ],
				[ 'category' => 'Recommended Vaccines', 'name' => 'Typhoid', 'who' => 'Most travellers, especially outside resorts', 'doses' => '1 dose', 'desc' => 'Worth considering where food and water hygiene may be variable, particularly in the Dominican Republic, Haiti and rural areas, or if visiting friends and family.' ],
				[ 'category' => 'Recommended Vaccines', 'name' => 'Tetanus, Diphtheria &amp; Polio (booster)', 'who' => 'Anyone not up to date', 'doses' => '1 booster dose', 'desc' => 'Often overlooked. A booster is sensible if it has been more than ten years, particularly for active or adventurous trips.' ],
				[ 'category' => 'Recommended Vaccines', 'name' => 'Hepatitis B', 'who' => 'Longer stays, healthcare work, possible medical exposure', 'doses' => '3-dose course (accelerated schedules available)', 'desc' => 'Worth discussing for longer trips, repeat visits, or anyone who may need medical or dental treatment while away.' ],
				[ 'category' => 'Also Worth Discussing', 'name' => 'Dengue (Qdenga)', 'who' => 'Travellers to areas with dengue activity', 'doses' => 'Course &mdash; pharmacist will advise', 'desc' => 'Dengue is the main mosquito-borne risk across the Caribbean, with periodic outbreaks. Ask our pharmacists whether the dengue vaccine is appropriate for you.' ],
				[ 'category' => 'Also Worth Discussing', 'name' => 'Rabies', 'who' => 'Longer stays, rural travel, likely animal contact', 'doses' => '3 doses over 21&ndash;28 days', 'desc' => 'Risk is low on most islands but present in some, including the Dominican Republic and Haiti. Worth considering for longer stays, rural travel or likely animal contact.' ],
				[ 'category' => 'Also Worth Discussing', 'name' => 'Yellow Fever', 'who' => 'Trinidad &amp; Tobago, or arriving from a yellow-fever endemic country', 'doses' => '1 dose (lifetime)', 'desc' => 'Not required for most Caribbean islands. Relevant for Trinidad &amp; Tobago, and a certificate may be required if you are arriving from a yellow-fever endemic country. Available at our Bosmere, Havant branch (NaTHNaC-registered centre).' ],
				[ 'category' => 'Also Worth Discussing', 'name' => 'MMR', 'who' => 'Anyone not up to date', 'doses' => 'Per UK schedule', 'desc' => 'Check you are up to date, as measles outbreaks occur periodically.' ],
			],
			'tv_risk_eyebrow' => 'Risk Awareness',
			'tv_risk_h2'    => 'Health Risks When Travelling to the Caribbean',
			'tv_risk_intro' => 'Understanding potential health risks helps you prepare properly. Our pharmacists assess your specific itinerary and activities to provide tailored advice.',
			'tv_risks'      => [
				[ 'title' => 'Mosquito-Borne Illness (Dengue &amp; Zika)', 'desc' => 'Dengue occurs across the region with periodic outbreaks. Zika is also present and is particularly important for anyone pregnant or planning pregnancy &mdash; speak to us before you travel.' ],
				[ 'title' => 'Food &amp; Water Safety', 'desc' => "Travellers' diarrhoea is the most common holiday illness. Bottled or treated water, care with ice, and freshly cooked food all reduce the risk. Hepatitis A and typhoid can be spread this way, which is why vaccination is recommended." ],
				[ 'title' => 'Water Sports &amp; Marine Injuries', 'desc' => 'Coral cuts, sea urchin spines and jellyfish stings are common. Keep wounds clean, and make sure your tetanus cover is current.' ],
				[ 'title' => 'Sun, Heat &amp; Humidity', 'desc' => 'Caribbean sun is stronger than most UK visitors expect. High-factor sun protection, shade in the middle of the day and good hydration all matter, especially for children.' ],
			],
			'tv_mal_eyebrow' => 'Malaria Risk',
			'tv_mal_h2'     => 'Do You Need Malaria Tablets for the Caribbean?',
			'tv_mal_intro'  => 'For most Caribbean destinations, no. Malaria is not a risk on the majority of islands, so antimalarial tablets are usually unnecessary &mdash; one reason the Caribbean is a straightforward destination to prepare for.',
			'tv_malaria'    => [
				[ 'title' => 'Where Risk Does Exist', 'desc' => 'Haiti is the main exception, with limited risk also noted in parts of the Dominican Republic. If your itinerary includes either, our pharmacists will assess whether antimalarials are appropriate.' ],
				[ 'title' => 'Dengue Matters More', 'desc' => 'Across the wider Caribbean, dengue is the more relevant mosquito-borne risk. Good bite avoidance is worthwhile everywhere, and the dengue vaccine may be an option.' ],
				[ 'title' => 'Bite Prevention', 'desc' => 'Use DEET-based repellent, cover up at dawn and dusk, and use air conditioning or screens where available. DEET repellents are stocked at all four branches.' ],
			],
			'tv_how_eyebrow' => 'Three-Step Process',
			'tv_how_h2'     => 'How to Get Your Caribbean Travel Vaccinations at Southdowns Pharmacy',
			'tv_how_intro'  => 'Three simple steps from booking to being fully protected.',
			'tv_how_steps'  => [
				...
				[ 'title' => 'Expert Travel Health Assessment', 'desc' => 'Our GPhC-registered pharmacists review your itinerary, medical history and planned activities to recommend only what you actually need for your Caribbean trip.' ],
				[ 'title' => 'Same-Day Vaccination', 'desc' => 'Receive your vaccines at the same appointment. Recommended vaccines are in stock across our branches, with Yellow Fever available at our Bosmere, Havant branch only.' ],
			],
			'tv_time_eyebrow' => 'Timing Guide',
			'tv_time_h2'    => 'When to Get Your Caribbean Travel Vaccinations',
			'tv_time_intro' => "Ideally book 6&ndash;8 weeks before departure &mdash; but don't worry if your trip is sooner. We accommodate last-minute travellers with same-day appointments.",
			'tv_timing'     => [
				[ 'tag' => 'Ideal', 'time' => '6–8 Weeks Before', 'desc' => "Best for multi-dose courses such as Hepatitis B, and allows the Yellow Fever certificate's 10-day validity if needed for Trinidad or transit." ],
				[ 'tag' => 'Good', 'time' => '2–4 Weeks Before', 'desc' => 'Still time for single-dose vaccines including Hepatitis A and Typhoid.' ],
				[ 'tag' => 'Last Minute', 'time' => 'Days Before Departure', 'desc' => 'Most single-dose vaccines can be given same-day. Come in even if you fly this week.' ],
			],
			'tv_price_eyebrow' => 'Transparent Pricing',
			'tv_price_h2'   => 'Caribbean Travel Vaccination Pricing',
			'tv_price_intro' => 'Transparent pricing with no hidden consultation fees. All prices include expert pharmacist assessment and vaccine administration.',
			...
			'tv_loc_eyebrow' => 'Find Us',
			'tv_loc_h2'     => 'Book at Your Nearest Hampshire Travel Clinic',
			'tv_loc_intro'  => 'Caribbean travel vaccinations available across our Southdowns Pharmacy travel clinics. Same-day appointments subject to availability. Free parking at all branches.',
			'tv_loc_yf_note' => 'Yellow Fever vaccinations and ICVP certificates are available at our Bosmere Pharmacy, Havant location only &mdash; relevant if you are travelling to Trinidad &amp; Tobago or arriving from a yellow-fever endemic country.',
			'tv_loc_footer' => 'Conveniently located to serve patients from across Hampshire including Portsmouth, Southsea, Waterlooville, Havant, Fareham, Gosport, Petersfield and Chichester.',
			'tv_why_eyebrow' => 'Our Promise',
			'tv_why_h2'     => 'Why Choose Southdowns Pharmacy for Your Caribbean Travel Vaccinations?',
			'tv_why'        => [
				[ 'title' => 'Expert GPhC-Registered Pharmacists', 'desc' => 'Qualified specialists in travel health providing evidence-based, personalised vaccination advice for every Caribbean itinerary.' ],
				[ 'title' => 'Caribbean Travel Vaccines in Stock', 'desc' => 'No ordering delays &mdash; we carry the recommended vaccines for Caribbean travel across our Hampshire branches.' ],
				[ 'title' => 'Same-Day Appointments', 'desc' => 'Walk in or book ahead &mdash; no waiting weeks for your travel vaccination appointment.' ],
				[ 'title' => 'NaTHNaC Yellow Fever Centre at Bosmere', 'desc' => 'For Trinidad &amp; Tobago and transit requirements, our Bosmere branch is an officially designated Yellow Fever Vaccination Centre issuing valid ICVP certificates.' ],
				[ 'title' => 'Four Hampshire Locations', 'desc' => 'Serving Portsmouth, Southsea, Waterlooville, Havant and wider Hampshire. Free parking at all sites.' ],
				[ 'title' => 'Family-Friendly Consultations', 'desc' => 'Child-safe dosing expertise and a welcoming environment for families travelling to the Caribbean with children of all ages.' ],
			],
			'tv_faq_eyebrow' => 'Common Questions',
			'tv_faq_h2'     => 'Frequently Asked Questions',
			'tv_faq_intro'  => 'Everything you need to know about Caribbean travel vaccinations at Southdowns Pharmacy.',
			'tv_faqs'       => [
				[ 'question' => 'Which vaccines do I need for the Caribbean?', 'answer' => 'Hepatitis A and typhoid are recommended for most travellers, along with an up-to-date tetanus, diphtheria and polio booster. Hepatitis B, rabies and the dengue vaccine may be advised depending on your itinerary. Our pharmacists confirm exactly what you need.' ],
				[ 'question' => 'Do I need malaria tablets for the Caribbean?', 'answer' => 'For most islands, no — malaria is not a risk across the majority of the Caribbean. Haiti is the main exception, with limited risk in parts of the Dominican Republic.' ],
				[ 'question' => 'Do I need a yellow fever certificate for the Caribbean?', 'answer' => 'Not for most islands. It is relevant for Trinidad & Tobago, and a certificate may be required if you are arriving from a yellow-fever endemic country.' ],
				[ 'question' => 'Is dengue a risk in the Caribbean?', 'answer' => 'Yes — dengue occurs across the region with periodic outbreaks. Bite avoidance matters, and a dengue vaccine may be appropriate for some travellers.' ],
				[ 'question' => "What about Zika if I'm pregnant?", 'answer' => 'Zika is present in the region and is particularly important in pregnancy. Please speak to us before booking travel so we can give you current advice.' ],
				[ 'question' => 'How far in advance should I book?', 'answer' => 'Ideally 6–8 weeks, though we offer same-day appointments and can help last-minute travellers.' ],
				[ 'question' => 'Can my whole family be vaccinated together?', 'answer' => 'Yes. We offer family appointments and child-appropriate dosing.' ],
				[ 'question' => 'Do I need vaccines for an all-inclusive resort?', 'answer' => 'Hepatitis A is still recommended, as food and water exposure is not eliminated by staying on a resort, and cuts or animal contact can happen anywhere.' ],
			],
			...
			'tv_cta_h2'     => 'Heading to the Caribbean?<br>Get Protected Before You Go.',
			'tv_cta_intro'  => 'Book your Caribbean travel vaccination consultation at any of our Hampshire locations. Expert advice, recommended vaccines in stock, same-day appointments available.',
			'tv_cta_btn1'   => 'Book a Travel Consultation',
			'tv_cta_btn2'   => 'Find Your Nearest Branch',
			'tv_trust'      => [
				[ 'value' => 'Expert', 'label' => 'Travel Health Advice' ],
			...
			'tv_disclaimer' => 'Travel health recommendations for the Caribbean are based on current NaTHNaC, WHO and MHRA guidance and are accurate as of August 2026. Requirements vary by island and may change &mdash; always consult the latest NaTHNaC or Foreign, Commonwealth &amp; Development Office guidance before travel. Vaccine suitability is assessed on an individual basis by our GPhC-registered pharmacists at the time of consultation.',
		],
